...
The canonical judge is **Gemma 4 E4B** (`google/gemma-4-E4B-it`), the same model the
...
as the judge yourself in this skill, mirror Gemma 4 E4B's PASS/FAIL rubric against
