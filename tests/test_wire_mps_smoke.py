...
# Extracted to the shared fixture module so the vLLM graph-engine tests build
# the SAME structural mirror (tests/gemma4_fixture.py).
from gemma4_fixture import gemma4_31b_shaped  # noqa: E402
