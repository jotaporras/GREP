...
def build_planner_model(gnn, llm, tokenizer, *, disable_graph_token_rope=False,
    ...
    if gnn.arch == "rpearl_llm":
        ...
        model = gnn_llm.LearnableGraphMaskLLM(
            ...
            # e19 hop-separated channels (docs/2026-08-23 e19 design note).
            post_fusion_hop_mode=gnn.get("post_fusion_hop_mode", "none"),
            post_fusion_hop_k=gnn.get("post_fusion_hop_k", 3),
            post_fusion_gain_init=gnn.get("post_fusion_gain_init", 0.0),
            post_fusion_codebook_size=gnn.get("post_fusion_codebook_size", 256),
            post_fusion_hop_gt_layers=gnn.get("post_fusion_hop_gt_layers", 3),
            post_fusion_hop_gt_heads=gnn.get("post_fusion_hop_gt_heads", 8),
            post_fusion_hop_gt_k=gnn.get("post_fusion_hop_gt_k", 1),
            ...
            soft_edges=gnn.get("soft_edges", False))
        collator = data.SpineDataCollator(tokenizer, mlm=False)
