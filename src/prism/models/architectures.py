...
def build_planner_model(gnn, llm, tokenizer, *, disable_graph_token_rope=False,
    ...
    if gnn.arch == "rpearl_llm":
        ...
        pe_model = r_pearl_module.RandomGNNPositionalEncodings(
            ...
            hidden_norm=gnn.get("hidden_norm", "none"),
        )
        ...
        model = _mask_cls(
            ...
            **({"tokenizer": tokenizer,
                ...
                "cache_pe": gnn.get("cache_pe", True),
                "bias_mode": gnn.get("mask_bias_mode", "log"),
                "decode_refresh": gnn.get("mask_decode_refresh", 8)} if _composite else {}),
            layer_scope=gnn.mask_layer_scope,
